...
makeplot <- function(party1, color1) {
  ...
  ggplot(data = temp2) +
    ...
    scale_fill_distiller(palette = color1, name = "Donations per Candidate", directions = 1) +
    labs(x = "", y = "") +
...
makeplot("REP", "Reds") +
    ...
    labs(title= "Donations Made to Republican Candidates", caption="Source: candidates.rda, contributions.rda")
