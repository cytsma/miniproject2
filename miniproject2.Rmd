...
TRying to do: create two data graphics, donations to dems and repus, so that we can compare parties, loyalty, which states have the most active local politics in terms of donations
